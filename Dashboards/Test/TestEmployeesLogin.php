...
EOF;
        ...
        if ( pg_num_rows($result) > 0 ){
            while( $rows = pg_fetch_assoc($result) ){
                ...
                header("Location: EmployeesDashboard.php");
            }
        }else{
...
<html lang="en">
  <head>
    ...
    <link href="../Employees/Pages/Assets/css/style.css" rel="stylesheet">
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">
                                ...
                                <p class=" login-form__footer">Not a employee? <a href="" class="text-primary">Log-In </a>as Admin now</p>
                                </form>
                            </div>
                        </div>
                    </div>
