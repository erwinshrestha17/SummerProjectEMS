        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Updating Employees</li>
                </ol>
        ...
        <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <div class="input-group input-group-outline border-0">
                <a href='employeesprofile.php' class='text-secondary font-weight-bold text-xs' data-toggle='tooltip' data-original-title='Edit user' >
                    <img src="../../Admin//Onboarding/img/<?php echo $image?>" alt="profile_image" class="w-100 border-radius-lg shadow-sm" width="130" height="60">
                </a>
            </div>
        </div>
    </nav>
                            ...
                            <form role="form" action="updatedata.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="input-group input-group-outline mb-3">
                                    <select class="form-select form-select-lg mb-2" name="role" required>
                                        ...
                                        <option class="outline mb-3" name="role" value="<?php echo $position ;?>">Full stack developer</option>
                                    </select>
                                    <div class="p-2"></div>
                                    ...
                                    <select class="form-select form-select-lg mb-2 " name="branch" required>
                                        ...
                                        <option class="outline mb-3" name="branch" value="<?php echo $organization;?>">Pokhara</option>
                                    </select>
                                </div>
                                <div class="input-group input-group-outline mb-3">
