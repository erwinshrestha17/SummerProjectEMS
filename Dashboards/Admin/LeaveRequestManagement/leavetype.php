                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Entitled</th>
                                ...
                                while ($let=pg_fetch_assoc($ret)){
                                    ...
                                    echo "<h6 class='mb-0 text-sm'>".$name."</h6>";
                                    echo "</div>";
                                    echo "</div>";
                                    echo" </td>";
                                    echo "
                                      ...
                                      <td class='align-middle text-center'>
                                       ...
                                       <td class='align-middle text-center'>
                                        <span class='text-secondary text-xs font-weight-bold'>  ".$entitled."</span>
                                    </td>
                                    ";


                                    echo "<td class='align-middle'>
                                        <form method='post' action='editleave.php'>
                                            <button class='btn btn-lg bg-gradient-primary btn-sm w-90 mt-2 mb-0' name='edit' value=$leavetypeid><i class='material-icons text-lg position-relative'>edit</i></button>
                                        </form>
                                    </td>";
