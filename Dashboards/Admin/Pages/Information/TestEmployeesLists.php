                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                while ($let=pg_fetch_assoc($ret)){
                                    ...
                                    echo "<div>";
                                    echo "<img src='' class='avatar avatar-sm me-3 border-radius-lg' alt='user1'>";
                                    echo "</div>";
                                ...
                                foreach ($arr as $var){
                                    ...
                                    foreach ($var as $item){
                                        ...
                                        echo "<div><img ></div>";
                                        echo "<div class='d-flex flex-column justify-content-center' > ";
                                        echo "<h6 class='mb-0 text-sm' >$item</h6>";
                                        echo "<p class='text-xs text-secondary mb-0'>$item</p>";
                                        echo "</div>";
                                    }
                                    echo "</div>";
                                    echo "</td>";
                                    echo "<td class='align-middle'><a href='#' class='text-secondary font-weight-bold text-xs ' data-toggle='tooltip' data-original-title='Edit User'>Edit</a></td>";
